...
ALTER TABLE `user_word_progress`
    ADD CONSTRAINT `user_word_progress_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `user_word_progress`
    ADD CONSTRAINT `user_word_progress_vocabularyWordId_fkey` FOREIGN KEY (`vocabularyWordId`) REFERENCES `vocabulary_words` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
